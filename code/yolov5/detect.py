...
def load_model():
    ...
    # 加载yolov5模型
    yolov5_model = torch.hub.load("./../../lib/yolov5lib",'custom', source='local', path = "./pthfiles/fromdxy.pt") 
...
#     # 创建更新图片线程
#     # threading.Thread(target=updatePic).start()
...
#         #进行推理
#         detect_pic(yolov5_model, picture)
